...
export default function Gross() {
  const [toggles, setToggles] = useState({light: 1, setcritchance: 0, precision: true, thiefmundus: true, slimecraw: true, morascribe: 0, nbassassin: 0, resists: 33000 });
          ...
          <Row className="py-5">
            <Col lg={6} sm={12}>
              <h5>Minor Prophecy / Savagery <Badge pill bg="primary">Group</Badge> (1314 = 6%)</h5>
                <Toggle id='hemorrhage' label='Nightblade Hemorrhage' onToggleClick={(e) => handleToggle(e)} />
                <Toggle id='exploitation' label='Sorcerer Exploitation' onToggleClick={(e) => handleToggle(e)} />
            ...
            <Col lg={6} sm={12}>        
              <h5>Sets</h5>
                ...
                <Toggle id='sulxan'label='Sul-Xan Proc (2160 = 9.8%)' onToggleClick={(e) => handleToggle(e)} />
                <Toggle id='slimecraw'label='Slimecraw 1pc (771 = 3.5%)' defaultvalue={true} onToggleClick={(e) => handleToggle(e)} />
                <Toggle id='orderswrath'label='Orders Wrath 5pc (943 = 4.3%)' onToggleClick={(e) => handleToggle(e)} />
                ...
                <Slider id='morascribe' label="Mora Scribe (128/major buff)" value={toggles['morascribe']} each={128} min={0} max={12} step={1} onToggleClick={(e) => handleToggle(e)} />
...
function calculateCritChance(toggles) {
  ...
  if (toggles['morascribe']) critchance=critchance+(128*toggles['morascribe']);
